...
<div className='btn' onClick={togglePop()}><button type='submit' className='btn btn-primary' >Send Message</button>{this.state.seen ? <PopUp toggle={this.togglePop} /> : null}</div>
